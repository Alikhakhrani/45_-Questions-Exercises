...
function myAlbum2(artistName:string,album:string,numbrroftracks?:number){
    return {artistName,album,numbrroftracks}
}

let album4 = myAlbum2("Ali","Rang-e-Muhabat",30);
let album5 = myAlbum2("Aslam","Roshan Andhera",50);
let album6 = myAlbum2("Amir","Masoom Dil");
