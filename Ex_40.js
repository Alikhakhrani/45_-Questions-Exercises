 ...
 */
// function myAlbum(artistName:string,album:string){
//     return {artistName,album}
// }
// let album1 = myAlbum("Ali","Rang-e-Muhabat");
// let album2 = myAlbum("Aslam","Roshan Andhera");
// let album3 = myAlbum("Amir","Masoom Dil");
// console.log(album1);
// console.log(album2);
// console.log(album3);
// number of tracks
function myAlbum2(artistName, album, numbrroftracks) {
    return { artistName: artistName, album: album, numbrroftracks: numbrroftracks };
}
var album1 = myAlbum2("Ali", "Rang-e-Muhabat", 30);
var album2 = myAlbum2("Aslam", "Roshan Andhera", 50);
var album3 = myAlbum2("Amir", "Masoom Dil");
console.log(album1);
console.log(album2);
console.log(album3);
