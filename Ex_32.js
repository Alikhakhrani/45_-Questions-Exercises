...
accepted. */
var current_users = ["Ali", "Ahmed", "maqsood", "Mazhar", "Momin", "Musawir"];
var New_users = ["Aslam", "Imtiyaz", "Naveed", "Noman", "Naseem", "Zulfiqar"];
// we will use forEach method
New_users.forEach(function (New_users) {
    var New_userLower = New_users.toLowerCase();
    ...
    if (userNameTaken) {
        console.log("".concat(New_users, "Needs to choose new username because its already taken"));
    }
    else {
        console.log("".concat(New_users, " is the new member addded"));
