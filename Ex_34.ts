...
let myPizza =["cheez pizza","pepproni pizza","vegeterian pizza"];

// print onlly names of pizza
...
console.log("\nI really like to eat pizza. pizza comes in a variety of flavours and toopings allowing indivisual to customize it to thier liking");